  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content={`${process.env.SITE_URL || 'https://qentra.cloud'}/og-image.png`} />
        ...
        <meta name="twitter:image" content={`${process.env.SITE_URL || 'https://qentra.cloud'}/og-image.png`} />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              logo: `${process.env.SITE_URL || 'https://qentra.cloud'}/logo.png`,
              sameAs: []
            })
          }}
        />
