    ...
    <section id="ai-automation" className="pt-12 relative">
      ...
      <div className="container relative z-10 grid md:grid-cols-2 gap-8 items-center">
        <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="md:col-span-1">
          <h3 className="text-3xl font-heading font-extrabold">Cognitive AI Automation & Agentic Workflows</h3>
          <p className="mt-4 text-white/80 max-w-xl">We build autonomous agent systems that reason, collaborate, and execute complex business functions. From custom LLM fine-tuning to semantic search architectures, we integrate cognitive intelligence directly into your product workflows.</p>
          <ul className="mt-6 space-y-2 text-white/80">
            <li>• Autonomous AI Agents & Multi-Agent Systems</li>
            <li>• Custom LLM Fine-Tuning & Prompt Engineering</li>
            <li>• Retrieval-Augmented Generation (RAG) & Vector DBs</li>
            <li>• Intent Classification & Cognitive Workflow Orchestration</li>
          </ul>
          <div className="mt-6">
