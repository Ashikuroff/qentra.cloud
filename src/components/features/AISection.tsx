    ...
    <section id="ai-automation" className="pt-12 relative">
      ...
      <div className="container relative z-10 grid md:grid-cols-2 gap-8 items-center">
        <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="md:col-span-1">
          <h3 className="text-3xl font-heading font-extrabold">AI Automation for Intelligent Operations</h3>
          <p className="mt-4 text-white/80 max-w-xl">We build intelligent automation: AI agents, workflow orchestration, LLM integrations, and copilots that reduce manual work and unlock actionable insights.</p>
          <ul className="mt-6 space-y-2 text-white/80">
            <li>• AI agents & intelligent workflows</li>
            <li>• Business process automation & orchestration</li>
            <li>• LLM integrations & custom copilots</li>
            <li>• AI-powered analytics & decisioning</li>
          </ul>
          <div className="mt-6">
